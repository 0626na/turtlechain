...
BUCKET_PROD='s3://product.turtlechain.io'

# cloudfront
CLOUDFRONT_DISTRIBUTION_ID='E3376HQ0CGURW4'
CLOUDFRONT_DISTRIBUTION_ID_TEST='EPXZ6O77AWBK3'
CLOUDFRONT_DISTRIBUTION_ID_PROD='E2ZF9FW81KQYOA'
...
function send_teams_message() {
  ...
  curl -d "{"@context":"https://schema.org/extensions","@type":"MessageCard","themeColor":"0072C6","title":"${title}","text":"${text}"}" -H "Content-Type: Application/JSON" -X POST https://turtleship.webhook.office.com/webhookb2/45c662af-63fc-4c15-af9a-dca5284cea67@357b41ce-1065-4820-bd19-b4750106b292/IncomingWebhook/f0006126b3bd43c38ccc3ee61f627328/b2dfea25-f801-4f8e-8bf5-8412247daafc
}
