    ...
    <MainLayout>
      <Suspense fallback="loading">
        <Switch>
          ...
          <Route
            exact
            path="/sample_return/create"
            component={SampleReturnCreatePage}
          />
          <Route
            exact
            path="/sample_return/list"
            component={SampleReturnListPage}
          />
          <Route
            exact
            path="/warehousing/create"
            component={WarehousingCreatePage}
          />
          <Route
            exact
            path="/warehousing/list"
            component={WarehousingListPage}
          />
          <Route
            exact
            path="/adjustment/create"
            component={AdjustmentCreatePage}
          />
          ...
          <Route
            ...
            component={ClearingBalancePage}
          />
          <Route
            exact
            path="/mistransfer/create"
            component={MistransferCreatePage}
          />
          <Route
            exact
            path="/mistransfer/list"
            component={MistransferListPage}
          />
