...
import orderAPI, { OrderItem } from '@apis/orderAPI';
    ...
    ({ type, search_string }: SearchState) => {
      setItemList([
        ...(getOrderItemQuery.data?.data.order_item_list.filter((item) => {
          ...
          if (type === 'vendor_name') {
            return item.product_info.vendor_info.vendor_name.includes(
              search_string,
            );
          }
          return (
      ...
      <Table
        ...
        columns={[
          ...
          },
          {
            ...
            title: '거래처 주소',
            render: (_, record) =>
              record.product_info.vendor_info.vendor_address,
          },
          {
            ellipsis: true,
            title: t('phone'),
            render: (_, record) =>
              record.product_info.vendor_info.vendor_phone.phone.replace(
                phonePattern,
                `$1-$2-$3`,
              ),
          },
